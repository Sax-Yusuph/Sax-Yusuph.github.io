...
(function (e, t, n, r) {
  ...
  o.prototype = {
    ...
    processContent: function (n, r) {
      ...
      if (r.attr("title") && r.attr("data-web") && r.attr("data-source") && r.attr("data-caption")) {
        var caption = e("<h3>", {class: "nivo-lightbox-caption"})
        caption.text(r.attr("data-caption"))
        var websiteButton = e("<a>", {href: r.attr("data-web")})
        var repoButton = e("<a>", {href: r.attr("data-source")})
        websiteButton.addClass("btn btn-dark mr-5")
        repoButton.addClass("btn btn-dark mr-5 repobtn")
        websiteButton.html('<i class="fas fa-eye mr-3"></i>Go to website')
        repoButton.html('<i class="fab fa-github mr-3"></i> View source code')

        var c = e("<h4>", { class: "nivo-lightbox-title" });

        c.text(r.attr("title"));
        e(".nivo-lightbox-title-wrap").html(c);
        c.before(caption)
        c.after(websiteButton, repoButton)
